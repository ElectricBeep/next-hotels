    ...
    <div className={styles.container}>
      ...
      >
        ...
        >
          ...
          {photos.map((img, index) => (
            <div className={index === current ? styles.slideActive : styles.slide} key={img.id}>
              {index === current && (
                <img src={`/img/${img.img}`} alt="hotel room" className={styles.img} />
              )}
            </div>
          ))}
        ...
        <div className={styles.smallImgContainer}>
          {photos.map((img, index) => (
            <img src={`/img/${img.img}`} alt="hotel room small" key={img.id} onClick={() => goToSlide(index)} className={current === index ? styles.activeSmallImg : styles.smallImg} />
          ))}
        </div>
      </motion.div>
    </div >
